...
int main(int argc, char** argv)
{
    ...
    int stop1=numOfrecords/8;
    int stop2=numOfrecords/4;
    int stop3=numOfrecords/2;
        ...
        if(sorter2==0){
            ...
            if(sorter3==0){
                ...
                if(sorter4==0){
                    ...
                    arg[0] = "./sorter";
                    char str[12];
                    sprintf(str, "%d", numOfrecords-stop3);
                    arg[1] = str;
                    arg[2] =argv[2];
                    arg[3] = argv[3];
                    arg[4] = NULL;
                    ...
                    MyRecord* a4=(MyRecord*)malloc((numOfrecords-stop3)*sizeof(MyRecord));
                    MyRecord* a12=(MyRecord*)malloc((stop2)*sizeof(MyRecord));
                    MyRecord* a34=(MyRecord*)malloc((numOfrecords-stop2)*sizeof(MyRecord));
                    ...
                    merge(a3,a4,a34,field,stop3-stop2,numOfrecords-stop2);
                    merge(a12,a34,final,field,stop2,numOfrecords);
